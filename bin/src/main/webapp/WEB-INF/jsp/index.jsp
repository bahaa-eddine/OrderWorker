...
<body>
<h1>Validation</h1>
<form:form action="http://localhost:8080/validation-history/" method="post" modelAttribute="workOrderModel">
...
<h1>History</h1>
<a href="/validation-history/getall">Validation History</a>
</body>
</html>